/* AUTO-GENERATED by scripts/build-manifest.py — do not edit by hand. */
window.WB_MANIFEST = {
  "name": "World Building",
  "description": "Creative alt-history & speculative-world scenarios. Source-of-truth corpus for the portal/community build-out.",
  "count": 8,
  "worlds": [
    "cognitive-husbandry",
    "new-tripoli",
  ...
  "documents": [
    {
      ...
      "type": "bible",
      "sim": ["feasibility", "kinetic-probe", "selection-sorter"],
      "novella": "true",
      "status": "canon",
    ...
    },
    {
      "world": "new-tripoli",
      "type": "canon",
      "sim": ["time-dilation", "comms-lag", "birthday-sacrifice", "layer-stack", "ring-density", "ganymede-cube", "hss-section", "wake-earth", "synthetic-body", "tech-tree", "molecular-assembler", "azure-janus"],
      "novella": "true",
      "status": "canon",
    ...
    },
    {
      "world": "new-tripoli",
      "type": "catalogue",
      "sim": ["spectrum", "deep-field", "cryonics"],
      "novella": "true",
      "status": "draft",
